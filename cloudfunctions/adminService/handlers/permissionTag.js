...
async function initSystem(params, cloud) {
  ...
  try {
    const defaultTags = [
      ...
      { tagId: 'scheduleViewer', tagName: '会议安排查看员', role: 'scheduleViewer', permissions: { canManageRooms: false, canDeleteRooms: false, canManagePublicResources: false, canApproveBookings: false, canViewBookingDetails: true, canViewAllUsers: false, canEditUsers: false, canManageApprovalRules: false, canManagePermissions: false, canManageSystem: false, canDatabaseManage: false, canAssignPermissionTags: false }, description: '可在会议室安排中查看预约详情，不可审批、不可进入管理后台' }
    ]
...
async function fixSystemTags(params, cloud) {
  ...
  try {
    const standardTags = [
      ...
      { tagId: 'scheduleViewer', name: '会议安排查看员', tagName: '会议安排查看员', role: 'scheduleViewer', description: '可在会议室安排中查看预约详情，不可审批、不可进入管理后台', permissions: { canManageRooms: false, canDeleteRooms: false, canManagePublicResources: false, canApproveBookings: false, canViewBookingDetails: true, canViewAllUsers: false, canEditUsers: false, canManageApprovalRules: false, canManagePermissions: false, canManageSystem: false, canDatabaseManage: false, canAssignPermissionTags: false } }
    ]
    const standardTagIds = ['system', 'super', 'academy', 'approval', 'scheduleViewer']
    const now = db.serverDate()
